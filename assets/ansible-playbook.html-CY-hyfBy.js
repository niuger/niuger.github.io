import{_ as p}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as l,o as i,c as o,b as n,e as s,d as e,a as t}from"./app-D1uezr0R.js";const c="/assets/true-1204916-20171208112235999-1825222840-BMVspc8H.png",u="/assets/true-image-20220729140706857-BnRcD9dW.png",r="/assets/true-image-20220729141300986-B9uKo0xr.png",d="/assets/true-image-20220729141702897-HFZuafnI.png",k="/assets/true-image-20220729141854324-DTDJ9LiC.png",m="/assets/true-image-20220729142232724-D68tGtUb.png",v="/assets/true-image-20220729143142605-BQe77Dmm.png",b="/assets/true-image-20220729143155466-A5mJji-S.png",g="/assets/true-image-20220729145916358-D8AhmfVj.png",h="/assets/true-image-20220729150326860-DRZUzK3s.png",y="/assets/true-image-20220729211246699-jkmu5SMa.png",x="/assets/true-image-20220729211332978-BW7KPunO.png",_="/assets/true-image-20220729212349643-Bz_VB0t4.png",f="/assets/true-image-20220729214251417-Coss9Ljt.png",q={},w=n("p",null,"Ansible-playbook任务编排工具（剧本）",-1),A=n("h1",{id:"ansible-playbook任务编排工具-剧本",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#ansible-playbook任务编排工具-剧本"},[n("span",null,"Ansible-playbook任务编排工具（剧本）")])],-1),j={href:"http://ansible.com.cn/docs/intro.html",target:"_blank",rel:"noopener noreferrer"},T={href:"https://pan.baidu.com/s/1fkosURl4HaYZALtSjKvcKg",target:"_blank",rel:"noopener noreferrer"},$=t(`<h2 id="ansible-playbook" tabindex="-1"><a class="header-anchor" href="#ansible-playbook"><span>ansible-playbook</span></a></h2><h3 id="简介" tabindex="-1"><a class="header-anchor" href="#简介"><span>简介</span></a></h3><p>playbook 是 ansible 用于配置，部署，和管理被控节点的剧本。</p><p>通过 playbook 的详细描述，执行其中的一系列 tasks ，可以让远端主机达到预期的状态。playbook 就像 Ansible 控制器给被控节点列出的的一系列 to-do-list ，而被控节点必须要完成。</p><p>也可以这么理解，playbook 字面意思，即剧本，现实中由演员按照剧本表演，在Ansible中，这次由计算机进行表演，由计算机安装，部署应用，提供对外服务，以及组织计算机处理各种各样的事情。</p><h3 id="使用场景" tabindex="-1"><a class="header-anchor" href="#使用场景"><span>使用场景</span></a></h3><p>执行一些简单的任务，使用ad-hoc命令可以方便的解决问题，但是有时一个设施过于复杂，需要大量的操作时候，执行的ad-hoc命令是不适合的，这时最好使用playbook。</p><p>就像执行shell命令与写shell脚本一样，也可以理解为批处理任务，不过playbook有自己的语法格式。</p><p>使用playbook你可以方便的重用这些代码，可以移植到不同的机器上面，像函数一样，最大化的利用代码。在你使用Ansible的过程中，你也会发现，你所处理的大部分操作都是编写playbook。可以把常见的应用都编写成playbook，之后管理服务器会变得十分简单。</p><h3 id="语法" tabindex="-1"><a class="header-anchor" href="#语法"><span>语法</span></a></h3><p>**playbook由YMAL语言编写。**YMAL格式是类似于JSON的文件格式，便于人理解和阅读，同时便于书写。</p><p>以下为playbook常用到的YMAL格式：</p><p>1、文件的第一行应该以 &quot;---&quot; (三个连字符)开始，表明YMAL文件的开始。</p><p>2、在同一行中，#之后的内容表示注释，类似于shell，python和ruby。</p><p>3、YMAL中的列表元素以”-”开头然后紧跟着一个空格，后面为元素内容。</p><p>4、同一个列表中的元素应该保持相同的缩进。否则会被当做错误处理。</p><p>5、play中hosts，variables，roles，tasks等对象的表示方法都是键值中间以&quot;:&quot;分隔表示，&quot;:&quot;后面还要增加一个空格。</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># 自定义主机与组
[web]
192.168.0.[8:10]
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="`+h+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>发现这样也是可以的</p><h4 id="_8-通过roles传递变量" tabindex="-1"><a class="header-anchor" href="#_8-通过roles传递变量"><span>⑧ 通过roles传递变量</span></a></h4>',115),N={href:"https://www.cnblogs.com/keerya/p/8004566.html#jump",target:"_blank",rel:"noopener noreferrer"},z=t(`<h4 id="_9-host-inventory" tabindex="-1"><a class="header-anchor" href="#_9-host-inventory"><span>⑨ Host Inventory</span></a></h4><p>我们也可以直接在主机清单中定义。</p><blockquote><p>向不同的主机传递不同的变量：</p></blockquote><div class="language-ABAP line-numbers-mode" data-ext="ABAP" data-title="ABAP"><pre class="language-ABAP"><code>IP/HOSTNAME varaiable=value var2=value2
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-定义-tasks-任务文件" tabindex="-1"><a class="header-anchor" href="#_4-定义-tasks-任务文件"><span>④ 定义 tasks 任务文件</span></a></h3><p>rpm包下载：</p>`,54),D={href:"http://nginx.org/packages/centos/7/x86_64/RPMS/nginx-1.22.0-1.el7.ngx.x86_64.rpm",target:"_blank",rel:"noopener noreferrer"},E=n("p",null,"chmod -R 777 nginx-1.22.0-1.el7.ngx.x86_64.rpm",-1),L=t(`<p><strong>vim /etc/ansible/roles/nginx/tasks/main.yml</strong></p><div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre class="language-yaml"><code><span class="token punctuation">---</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+_+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="_12-测试修改后重新加载配置文件-reloadnginx" tabindex="-1"><a class="header-anchor" href="#_12-测试修改后重新加载配置文件-reloadnginx"><span>12 测试修改后重新加载配置文件 - reloadnginx</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@admin nginx<span class="token punctuation">]</span><span class="token comment"># vim ./vars/main.yml</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+f+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>',40);function C(S,H){const a=l("ExternalLinkIcon");return i(),o("div",null,[w,A,n("p",null,[n("a",j,[s("ansible 中文指南"),e(a)])]),n("p",null,[n("a",T,[s("本节示例文件 提取码：1234"),e(a)])]),$,n("p",null,[s("具体的，我们下文中说到 roles 的时候再详细说明。这里是"),n("a",N,[s("传送带"),e(a)])]),z,n("blockquote",null,[n("p",null,[s("wget "),n("a",D,[s("http://nginx.org/packages/centos/7/x86_64/RPMS/nginx-1.22.0-1.el7.ngx.x86_64.rpm"),e(a)])]),E]),L])}const B=p(q,[["render",C],["__file","ansible-playbook.html.vue"]]),I=JSON.parse('{"path":"/linux/ansible/ansible-playbook.html","title":"Ansible-playbook任务编排工具（剧本）","lang":"zh-CN","frontmatter":{"icon":"linux","title":"Ansible-playbook任务编排工具（剧本）","category":["Linux"],"headerDepth":5,"date":"2022-07-29T00:00:00.000Z","order":4,"tag":["Ansible"],"description":"Ansible-playbook任务编排工具（剧本）","head":[["meta",{"property":"og:url","content":"https://blogres.github.io/linux/ansible/ansible-playbook.html"}],["meta",{"property":"og:title","content":"Ansible-playbook任务编排工具（剧本）"}],["meta",{"property":"og:description","content":"Ansible-playbook任务编排工具（剧本）"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-02-02T11:49:35.000Z"}],["meta",{"property":"article:author","content":"blogres"}],["meta",{"property":"article:tag","content":"Ansible"}],["meta",{"property":"article:published_time","content":"2022-07-29T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2024-02-02T11:49:35.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Ansible-playbook任务编排工具（剧本）\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2022-07-29T00:00:00.000Z\\",\\"dateModified\\":\\"2024-02-02T11:49:35.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"blogres\\",\\"url\\":\\"/article\\"}]}"]]},"headers":[{"level":2,"title":"ansible-playbook","slug":"ansible-playbook","link":"#ansible-playbook","children":[{"level":3,"title":"简介","slug":"简介","link":"#简介","children":[]},{"level":3,"title":"使用场景","slug":"使用场景","link":"#使用场景","children":[]},{"level":3,"title":"语法","slug":"语法","link":"#语法","children":[]},{"level":3,"title":"示例剧本文件","slug":"示例剧本文件","link":"#示例剧本文件","children":[]},{"level":3,"title":"核心元素","slug":"核心元素","link":"#核心元素","children":[]},{"level":3,"title":"基本组件","slug":"基本组件","link":"#基本组件","children":[{"level":4,"title":"① 定义 playbook","slug":"_1-定义-playbook","link":"#_1-定义-playbook","children":[]},{"level":4,"title":"② 测试安装 nginx","slug":"_2-测试安装-nginx","link":"#_2-测试安装-nginx","children":[]},{"level":4,"title":"③ 测试 start","slug":"_3-测试-start","link":"#_3-测试-start","children":[]},{"level":4,"title":"④ 测试 restarted","slug":"_4-测试-restarted","link":"#_4-测试-restarted","children":[]}]},{"level":3,"title":"variables 变量","slug":"variables-变量","link":"#variables-变量","children":[{"level":4,"title":"① facts ：可直接调用","slug":"_1-facts-可直接调用","link":"#_1-facts-可直接调用","children":[]},{"level":4,"title":"② 用户自定义变量","slug":"_2-用户自定义变量","link":"#_2-用户自定义变量","children":[]},{"level":4,"title":"③ 定义剧本","slug":"_3-定义剧本","link":"#_3-定义剧本","children":[]},{"level":4,"title":"④ 拷贝配置文件","slug":"_4-拷贝配置文件","link":"#_4-拷贝配置文件","children":[]},{"level":4,"title":"⑤ 运行剧本，变量由命令行传入","slug":"_5-运行剧本-变量由命令行传入","link":"#_5-运行剧本-变量由命令行传入","children":[]},{"level":4,"title":"⑥ 修改剧本，直接定义变量","slug":"_6-修改剧本-直接定义变量","link":"#_6-修改剧本-直接定义变量","children":[]},{"level":4,"title":"⑦ 运行定义过变量的剧本","slug":"_7-运行定义过变量的剧本","link":"#_7-运行定义过变量的剧本","children":[]},{"level":4,"title":"⑧ 通过roles传递变量","slug":"_8-通过roles传递变量","link":"#_8-通过roles传递变量","children":[]},{"level":4,"title":"⑨  Host Inventory","slug":"_9-host-inventory","link":"#_9-host-inventory","children":[]}]},{"level":3,"title":"templates 模板","slug":"templates-模板","link":"#templates-模板","children":[{"level":4,"title":"① 定义模板","slug":"_1-定义模板","link":"#_1-定义模板","children":[]},{"level":4,"title":"② 修改剧本","slug":"_2-修改剧本","link":"#_2-修改剧本","children":[]},{"level":4,"title":"③ 运行剧本","slug":"_3-运行剧本","link":"#_3-运行剧本","children":[]}]},{"level":3,"title":"条件测试","slug":"条件测试","link":"#条件测试","children":[]},{"level":3,"title":"循环","slug":"循环","link":"#循环","children":[]},{"level":3,"title":"字典","slug":"字典","link":"#字典","children":[]}]},{"level":2,"title":"角色订制 roles 以 nginx 为例","slug":"角色订制-roles-以-nginx-为例","link":"#角色订制-roles-以-nginx-为例","children":[{"level":3,"title":"① 简介","slug":"_1-简介","link":"#_1-简介","children":[]},{"level":3,"title":"② 目录说明","slug":"_2-目录说明","link":"#_2-目录说明","children":[]},{"level":3,"title":"③ 在roles目录下生成对应的目录结构","slug":"_3-在roles目录下生成对应的目录结构","link":"#_3-在roles目录下生成对应的目录结构","children":[]},{"level":3,"title":"准备 nginx.conf.j2 配置文件","slug":"准备-nginx-conf-j2-配置文件","link":"#准备-nginx-conf-j2-配置文件","children":[]},{"level":3,"title":"④ 定义 tasks 任务文件","slug":"_4-定义-tasks-任务文件","link":"#_4-定义-tasks-任务文件","children":[]},{"level":3,"title":"⑤ 放置我们所需要的文件到指定目录","slug":"_5-放置我们所需要的文件到指定目录","link":"#_5-放置我们所需要的文件到指定目录","children":[]},{"level":3,"title":"⑥ 定义 vars 变量文件","slug":"_6-定义-vars-变量文件","link":"#_6-定义-vars-变量文件","children":[]},{"level":3,"title":"⑦ 定义 handlers 文件","slug":"_7-定义-handlers-文件","link":"#_7-定义-handlers-文件","children":[]},{"level":3,"title":"⑧ 定义 nginx 剧本文件","slug":"_8-定义-nginx-剧本文件","link":"#_8-定义-nginx-剧本文件","children":[]},{"level":3,"title":"⑨ 启动服务","slug":"_9-启动服务","link":"#_9-启动服务","children":[]},{"level":3,"title":"⑩ 启动过后照例查看端口号","slug":"_10-启动过后照例查看端口号","link":"#_10-启动过后照例查看端口号","children":[]},{"level":3,"title":"11 测试修改后重新加载配置文件 - restartnginx","slug":"_11-测试修改后重新加载配置文件-restartnginx","link":"#_11-测试修改后重新加载配置文件-restartnginx","children":[]},{"level":3,"title":"12 测试修改后重新加载配置文件 - reloadnginx","slug":"_12-测试修改后重新加载配置文件-reloadnginx","link":"#_12-测试修改后重新加载配置文件-reloadnginx","children":[]}]}],"git":{"createdTime":1706536810000,"updatedTime":1706874575000,"contributors":[{"name":"topjfy","email":"topjfk@163.com","commits":2}]},"readingTime":{"minutes":17.66,"words":5297},"filePathRelative":"linux/ansible/ansible-playbook.md","localizedDate":"2022年7月29日","excerpt":"<p>Ansible-playbook任务编排工具（剧本）</p>\\n","autoDesc":true}');export{B as comp,I as data};
